...
/** 史实资料中的一个内容小节（博物馆展签式：时代背景 / 用镜之道 / 纹样语言 / 这一面镜） */
...
export interface Reference {
  title: string
  /** 单段说明（旧结构；有 sections 时前端优先渲染 sections） */
  detail?: string
  /** 结构化多段展签内容（存在时优先于 detail 渲染） */
...
const mirrors: Mirror[] = [
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '商代崇尚祭祀、敬畏鬼神，铜是贵重的礼器材料。早期铜镜形制小巧，多出于高等级墓葬，与玉器、青铜器同出，可能兼具礼器与仪仗之用。',
        },
        {
          heading: '用镜之道',
          body: '照容并非商镜的主要用途——它更像是贵族身份与随葬等级的象征。妇好墓同出四面铜镜，正是这种特殊性的写照。',
        },
        {
          heading: '纹样语言',
          body: '极简是商镜的基调：几乎只有几圈同心弦纹。这种近乎抽象的朴素，与同代青铜器上繁复的饕餮、云雷纹形成鲜明反差。',
        },
        {
          heading: '这一面镜',
          body: '商代弦纹铜镜：镜面微凸，弓形钮，圆钮座，钮座外饰凸弦纹七周，弦纹间有放射状短线。同类镜出土于河南安阳殷墟妇好墓——墓主为商王武丁的王后妇好，墓内随葬铜镜四面，此为其一。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '春秋礼崩乐坏、诸侯争霸，青铜铸造与世俗趣味同步上升。铜镜从纯装饰走向"画面"，动物开始成为镜背的主角。',
        },
        {
          heading: '用镜之道',
          body: '铜镜仍与贵族阶层紧密相关，但镜背题材愈发贴近现实——狩猎、走兽、飞鸟，映照出这个时代对自然生灵的关注。',
        },
        {
          heading: '纹样语言',
          body: '写实化的动物纹渐次涌现：钮上奔鹿、钮下飞鸟、两侧张口虎纹，繁简有度，铜镜第一次"讲起了故事"。',
        },
        {
          heading: '这一面镜',
          body: '春秋鸟兽纹镜：圆形，镜背中央两枚平行弓形钮。钮上行鹿抬头前伸，钮下飞鸟昂首，左右变形虎纹巨口利爪、饰圆涡纹，长尾呈 S 形下垂外卷。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '战国是思想与工艺并盛的时代，百家争鸣，错金银等精细工艺趋于成熟；楚地尤其以浪漫奇诡的审美见长。',
        },
        {
          heading: '用镜之道',
          body: '铜镜逐渐成为日常梳妆用具，江南、楚地墓葬大量出土，镜奁、妆具随之出现，照容功能日益突出。',
        },
        {
          heading: '纹样语言',
          body: '抽象几何纹为主流——曲折雷纹、云纹、山字纹，对称严密、秩序感极强，是对天地规则的抽象表达。',
        },
        {
          heading: '这一面镜',
          body: '曲折雷纹镜的主纹以曲折多变的雷纹为设计核心，源于商周青铜器上常见的勾连雷纹——繁复而富有动感的线条，展现古人对于自然界的敬畏与崇拜。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '汉代大一统，天人感应与谶纬之说盛行，铜镜发展出成熟的"规矩四神"宇宙图式，铭文文化也随之兴盛。',
        },
        {
          heading: '用镜之道',
          body: '铜镜是汉代最重要的日用与随葬品之一：梳妆照容、悬镜喻示清正、随葬护身，镜铭常寄寓"见日之光""长宜子孙"等祝福。',
        },
        {
          heading: '纹样语言',
          body: '博局纹（TLV 纹）与四神、神兽、云气相配，讲求对称与方位。"博局纹"源自六博棋盘，象征法天象地、包罗宇宙。',
        },
        {
          heading: '这一面镜',
          body: '东汉至西汉末（公元 9–100 年），青铜，直径 19 厘米。镜背是一幅宇宙图式：同心圆环与云气纹象征天，钮座方框象征地，四神居天地之间。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '隋结束南北分裂、重归一统，佛教在北朝基础上更盛，南北文化交融为铜镜带来新的题材与吉祥意味。',
        },
        {
          heading: '用镜之道',
          body: '铜镜随葬普遍，也见于佛教供养语境；隋镜的铭文与生肖多寄寓长命、平安、宜新等祝愿。',
        },
        {
          heading: '纹样语言',
          body: '十二生肖环列、云气缭绕，镜钮下常设莲瓣座；宗教与吉祥元素开始在本已圆融的镜背上显山露水。',
        },
        {
          heading: '这一面镜',
          body: '圆形镜，半球钮，圆钮座上有铭文“光正随人，长命宜新”，字间饰小凸点；外圈十二方格环以云气生肖，最外圈锯齿纹、三角斜缘。同类镜出土于河南陕县刘家渠刘伟墓及陕西西安李静训墓，为隋初新式镜样。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '盛唐开放包容、中西交流频繁，葡萄等异域物产传入中原；审美奔放华丽，世俗生活气息浓厚。',
        },
        {
          heading: '用镜之道',
          body: '唐妆盛行，铜镜是女性梳妆的日常必需，也常作赏赐、赠礼与定情之物；随葬与妆奁文化尤为发达。',
        },
        {
          heading: '纹样语言',
          body: '海兽葡萄、花鸟瑞兽、人物故事等高浮雕纹样在方寸之间层层铺展，菱花、葵花等新形制亦百花齐放。',
        },
        {
          heading: '这一面镜',
          body: '唐中期（7 世纪中叶），青铜，直径仅 8.2 厘米。瑞兽与葡萄蔓枝以高浮雕在方寸之间层层铺展，是盛唐华丽审美的缩影。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '宋代城市商业繁荣、理学兴起，审美转向内敛素雅；文人好古，作旧、仿古之风渐起。',
        },
        {
          heading: '用镜之道',
          body: '铜镜从贵重礼器变为日常商品，"湖州镜"等铸镜作坊的商标式铭文兴起——照容更普及，也更有市井烟火气。',
        },
        {
          heading: '纹样语言',
          body: '由唐的繁复转向素雅：镜背趋于净面，或仅以疏朗铭文为饰；葵花、菱花等花形镜缘尤受欢迎。',
        },
        {
          heading: '这一面镜',
          body: '宋代葵花型铜镜，镜缘作葵花瓣状，镜背素净、铭文疏朗——审美由繁复纹样转向器形与质地本身；铸镜业的商标式铭文（如湖州匠号）正是宋镜的标志。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '元代疆域广阔、民族多元，藏传佛教与中原信仰交融；铜镜的世俗实用与宗教护佑并存。',
        },
        {
          heading: '用镜之道',
          body: '铜镜不仅照容，也被赋予辟邪护身的功能——准提咒等铭文让一面镜子成为可随身携带的信仰法器。',
        },
        {
          heading: '纹样语言',
          body: '装饰让位于文字：兰札体梵文咒语内外两圈环列，宗教文字本身即是镜背的纹样。',
        },
        {
          heading: '这一面镜',
          body: '梵文准提咒镜盛行于元明，兰札体咒语双圈反向环列。依准提坛法，以未曾用之新镜供于佛像前，持咒一百八遍，以囊盛镜随身——镜子由此成为信仰的法器。',
        },
      ],
  ...
  },
  {
    ...
    reference: {
      ...
      sections: [
        {
          heading: '时代背景',
          body: '明代市民文化繁荣，科举与吉祥观念深入人心；铜镜彻底世俗化、商品化，成为居家常见之物。',
        },
        {
          heading: '用镜之道',
          body: '铜镜常作嫁妆、定情与居家吉祥物，铭文多寄寓多子、登科、福寿等世俗祝愿，祈愿色彩浓厚。',
        },
        {
          heading: '纹样语言',
          body: '仿古与吉祥铭文并行——「五子登科」等直白吉庆文字环钮而铸，铜镜由文人之雅走向寻常人家。',
        },
        {
          heading: '这一面镜',
          body: '「五子登科」吉祥铭文镜流行于明代，黄铜质地，铭文方框环钮而铸——照见寻常人家对科举登第、多子多福的朴素愿望。',
        },
      ],
